    ...
    <div style={{padding:'16px'}}>
      <div style={{display:'flex',gap:6,marginBottom:14}}>
        {SPIN_LABELS.map((label,i)=>(
          <button key={i} onClick={()=>setActiveSpin(i)} style={{flex:1,padding:'8px 4px',borderRadius:8,cursor:'pointer',fontFamily:"'DM Mono',monospace",fontSize:11,fontWeight:600,letterSpacing:1,
