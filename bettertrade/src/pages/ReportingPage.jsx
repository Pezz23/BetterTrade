...
export default function ReportingPage() {
  ...
  async function salvaGiornata() {
    ...
    const activeSpins=spinData.filter(d=>d!==null)
    const totInvestito=parseFloat(activeSpins.reduce((s,d)=>s+(d.investito||0),0).toFixed(2))
    const totIncasso=parseFloat(activeSpins.reduce((s,d)=>s+(d.incasso||0),0).toFixed(2))
